			...
			<?php if (have_posts()) :
				...
				<div class="home-columns clearfix">
					...
					<div class="one-half">
						...
						$opinionPosts = new WP_Query('cat=1&posts_per_page=2&order=ASC');
						...
						<span class="horiz-center"><a href="<?php echo get_category_link(1); ?>" class="btn-a">View all Opinion Posts</a></span>
